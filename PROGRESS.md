...
- Idée notée par l'utilisateur le 2026-07-12, volontairement **non traitée aujourd'hui** (scope séparé) : transformer l'usage de Blue en brique optionnelle de MyProjectOS, avec une gouvernance de nommage/remplissage de cartes pré-remplie et réutilisable par tout projet qui adopte Blue (au lieu du gabarit générique vide `GOUVERNANCE_INTEGRATION.md`). À cadrer via un nouveau RETEX/DEC quand `GOUVERNANCE_BLUE.md` de Projet Alpha aura assez vécu pour en extraire ce qui est vraiment générique.
