...
1. **Au démarrage** : fichiers sacrés Core (lecture allégée) + sommaire (`SUJETS.md`, `docs/INDEX.md`, `docs/kb_governance.md`). Rien au-delà : pas de niveau Domaines ni Détails par défaut.
