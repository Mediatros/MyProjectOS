...
2. Un projet réel (banc d'essai Projet Zeta) tourne avec la méthode et les frictions relevées sont corrigées.
...
- Documents de passation et d'analyse d'orientation internes : base de travail initiale.
- Un plan interne en cours (installation réelle, méthode 2, navigation 3 niveaux).
