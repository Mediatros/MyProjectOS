...
- [ ] **T-PLAN-6** Relire et arbitrer séparément les six améliorations candidates issues de Pro Workflow (`PLAN/plans/2026-07-29-pro-workflow-integration.md`) : garde-fou Git, scan de secrets, boucle de correction gouvernée, clôture Code, index FTS5 Knowledge, inventaire des hooks. Pour chacune : retenir, expérimenter, reporter ou rejeter. Aucun code/hook avant décision explicite.
