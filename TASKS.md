...
- [ ] **T-PLAN-8** Extension Knowledge v2 — hiérarchie documentaire à 4 niveaux (un plan interne) : formuler par échange avec l'utilisateur une version aboutie de la proposition Hermes (N1 constitution / N2 méso / N3 micro / N4 archives, nommage N3 miroir du N2 parent), puis comparer explicitement avec l'extension Knowledge actuelle (niveaux 1/2/3) avant toute décision d'adoption. Aucune modification de `templates/extensions/knowledge/` avant arbitrage.
